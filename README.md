...
[![nbviewer](https://raw.githubusercontent.com/jupyter/design/master/logos/Badges/nbviewer_badge.svg)](https://nbviewer.jupyter.org/github/SeanOhAileasa/nkp-cybersecurity-apprenticeship/blob/main/nkp-cybersecurity-apprenticeship.ipynb)
...
- The software must be downloaded and run on a machine as follows:
	...
	``git clone https://github.com/SeanOhAileasa/nkp-cybersecurity-apprenticeship.git``

  - Run Jupyter Notebooks from the command line with the following:

	``jupyter notebook``

  - Open notebook - ``nkp-cybersecurity-apprenticeship.ipynb``
